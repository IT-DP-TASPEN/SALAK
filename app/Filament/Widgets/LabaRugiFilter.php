...
class LabaRugiFilter extends Widget implements HasForms
{
    use InteractsWithForms;

    protected static string $view = 'filament.widgets.laba-rugi-filter';
        ...
        return $form
            ...
            ->schema([
                ...
                Select::make('branch_office')
                    ...
                    ->columnSpanFull()
                    ->afterStateUpdated(function (?string $state): void {
                        $this->dispatch('labaRugiBranchOfficeChanged', blank($state) ? null : $state);
                    }),
            ]);
    }
}
