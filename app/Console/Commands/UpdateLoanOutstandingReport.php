...
class UpdateLoanOutstandingReport extends Command
{
    ...
    private static function mapHeaderToField(string $header): ?string
    {
        return match (trim(strtolower($header))) {
            ...
            // Date Params	Branch Code	Product ID	Loan Account No	Customer Name	CIF No	CIF Alt No	Loan Alt No	Credit Limit No	Loan Agreement No	Start Date	End Date	Interest Rate	Installments Loan	Principal Installments Loan	Interest Installments Loan	BI Collectability	Day Past Due	Currency	Loan Principal	Loan Outstanding	Principal Arrears	Interest Arrears	Penalty Arrears	Accrue Interest	Marketing Code
            'date params' => 'loan_date_params',
            'branch code' => 'loan_branch_office',
            'product id' => 'loan_product',
            'loan account no' => 'loan_account',
            'customer name' => 'loan_customer',
            'cif no' => 'loan_cif',
            'cif alt no' => 'loan_cif_alt',
            'loan alt no' => 'loan_alt_account',
            'credit limit no' => 'loan_credit_limit_no',
            'loan agreement no' => 'loan_agreement_no',
            'start date' => 'loan_start_date',
            'end date' => 'loan_end_date',
            'interest rate' => 'loan_interest_rate',
            'installments loan' => 'loan_installment_loans',
            'principal installments loan' => 'loan_installment_principal',
            'interest installments loan' => 'loan_installment_interest',
            'bi collectability' => 'loan_bi_collectability',
            'day past due' => 'loan_days_past_due',
            'currency' => 'loan_currency',
            'loan principal' => 'loan_principal',
            'loan outstanding' => 'loan_outstanding',
            'principal arrears' => 'loan_principal_arrears',
            'interest arrears' => 'loan_interest_arrears',
            'penalty arrears' => 'loan_penalty_arrears',
            'accrue interest' => 'loan_accrue_interest',
            'marketing code' => 'loan_marketing_code',
